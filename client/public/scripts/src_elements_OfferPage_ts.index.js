...
class OfferPage extends HTMLElement {
    connectedCallback() {
        ...
        const controller = new _controllers_OfferController__WEBPACK_IMPORTED_MODULE_1__["default"](offerElement);
